...
const SocialBar = () => {
  return (
    <nav className="hidden md:block fixed z-10 left-5 lg:left-10 right-auto bottom-0 w-10 text-light-slate" aria-orientation="vertical">
            ...
            {socialLinks.map((item) => {
                ...
                return (
                    <li key={item.id} className="h-11 w-fit mx-auto">
                        ...
                        rel="noopener referrer" className="size-fit">
